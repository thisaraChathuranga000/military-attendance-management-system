        ...
        <div style={{ paddingTop: 40, paddingLeft: 60 }}>
          ...
          <div style={{ display: "flex", flexDirection: "row" }}>
            <div style={{ marginRight: "200px" }}>
              ...
              <p style={{ margin: "0" }}>
                Select your parade participation status
              </p>
            </div>
              ...
              <FormControl sx={{ marginBottom: 2 }}>
                ...
                >
                  <FormControlLabel
                    value="OnParade"
                    control={<Radio />}
                    label="Yes, I have participated"
                  />
                  <FormHelperText
                    sx={{ margin: 0 }}
                  >{`(Please select this option if you successfully engaged in the parade.)`}</FormHelperText>
                  <FormControlLabel
                    value="NotOnParade"
                    control={<Radio />}
                    label="No, I was unable to participate"
                  />
                  <FormHelperText
                    sx={{ margin: 0 }}
                  >{`(Please select this option if you successfully engaged in the parade.)`}</FormHelperText>
