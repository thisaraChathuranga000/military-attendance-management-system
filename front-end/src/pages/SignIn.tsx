...
import { Box, Button, Card, CardActions, CardContent, Container, FormControl, Grid, MenuItem, Select, SelectChangeEvent, TextField, Typography } from '@mui/material';
      ...
      <Grid container>
        <Grid  item lg={6} md={6} xs={12} container sx={{pl:10, pt:5, display:"flex", flexDirection:"column", }}>
          ...
          <div style={{display:"flex", flexDirection:"column"}}>
            ...
            <TextField fullWidth label="Enter your user name" id="fullWidth" sx={{maxWidth:350 ,marginBottom:"20px"}} value={username} onChange={(e) => setUsername(e.target.value)}  />

            <label style={{marginBottom:"15px"}}>Password</label>
            <TextField fullWidth label="Enter your Password" id="fullWidth" sx={{maxWidth:350, marginBottom:"20px"}}  value={password} onChange={(e) => setPassword(e.target.value)} />

            <Button variant="contained" sx={{maxWidth:350, backgroundColor:"#C68D4D"}} onClick={handleSignIn}>
              Sign in
            </Button>
